        ...
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" action="" method="post" name="car_detailing">
              ...
              <div class="form-label-group">
                Email Address<input type="email" id="inputEmail" name="email" class="form-control" placeholder="Email" onkeyup="validateEmail()"required >
              </div>
              ...
              <br>
              <center><a class="btn btn-warning btn-xl text-uppercase js-scroll-trigger" href="SERVICES.html">PREVIOUS PAGE</a></center>
            </form>
          </div>
        </div>
      </div>
